...
for (const mode of ["mock", "sqlite"] as const) describe(`${mode} G04 actual task/file contract`, () => {
    ...
    it("SA-03 exact reference bytes stay private before publish, survive revisions and revoke with membership", async () => {
    ...
    it("SA-03 upload failure leaves no metadata/orphan bytes; unsupported preview preserves original download", async () => {
