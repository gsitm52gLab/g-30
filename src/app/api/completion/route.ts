...
export async function POST(request: Request) { return route(request, async (s, t) => json(await new CompletionService(s).command(t, await readBody(request, commandKeys, 128 * 1024)))); }
