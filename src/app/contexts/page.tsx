...
export default async function Contexts() { const data = await (async () => { const service = await identity(); return service.me(await currentToken()); })().catch(workspaceFailure); if (!data)
    return <StorageFailure />; return <ContextManager initial={data}/>; }
