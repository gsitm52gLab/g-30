...
export type StartAnalysis = { inputVersionId: string; extractionRunId: string; expectedRunId: string | null; corpusReleaseId: string; corpusManifestHash: string; engine: 'synthetic_demo'; idempotencyKey: string };
