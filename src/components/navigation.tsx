...
export function Navigation() {
    ...
    return <nav aria-label="주 메뉴" className={styles.nav}>{[["/", "홈", "01"], ["/tasks", "업무", "02"], ["/products", "상품정보", "03"], ["/projects", "입점 프로젝트", "04"], ["/contexts", "컨텍스트·회원", "05"], ["/materials", "자료함·제출표", "06"], ["/notices", "공지·가이드", "07"]].map(([href, label, number]) => {
