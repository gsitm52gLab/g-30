...
export function ScheduleEditor({ value, onChange, dateTime, onDateTimeChange, tasks, responsibleOptions, responsibilityHelp, disabled = false, taskLocked = false, canSelectInternal, error }: Props) {
